...
public class OtpControllerTest {
	...
	public void test_should_return_success_response_when_otp_is_sent() throws Exception {
		...
		final OtpRequest expectedOtpRequest = new OtpRequest("mobileNumber", "tenantId", OtpRequestType.PASSWORD_RESET, "CITIZEN", "locale");
	...
	public void test_should_return_error_response_when_user_alreadyExist_incaseoftypeisregister() throws Exception {
		final OtpRequest expectedOtpRequest = new OtpRequest("mobileNumber", "tenantId", OtpRequestType.REGISTER, "CITIZEN", "locale");
	...
	public void test_should_return_error_message_when_unhandled_exception_occurs() throws Exception {
		final OtpRequest expectedOtpRequest = new OtpRequest("mobileNumber", "tenantId", null, "CITIZEN", "locale");
