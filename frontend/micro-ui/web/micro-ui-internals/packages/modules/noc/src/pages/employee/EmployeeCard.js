...
const NOCEmployeeHomeCard = () => {
  ...
  useEffect(() => {
    if (location.pathname === "/mgramseva-digit-ui/employee") {
      ...
      kpis: [
        {
          ...
          label: t("TOTAL_FSM"),
          link: `/mgramseva-digit-ui/employee/obps/inbox`,
        },
        { count: !isInboxLoading ? nearingSlaCount : "-", label: t("TOTAL_NEARING_SLA"), link: `/mgramseva-digit-ui/employee/obps/inbox` },
      ],
      links: [
        {
          count: totalCount,
