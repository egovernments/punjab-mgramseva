  ...
  let links = [
    {
      ...
      link: `/mgramseva-digit-ui/employee/reports/search/pt-reports/PTReceiptRegister`,
      roles: ["UC_EMP", "PT_CEMP"],
    },
    {
      label: t("ACTION_TEST_COLLECTION_REGISTER"),
      link: `/mgramseva-digit-ui/employee/reports/search/pt-reports/PTCollectionReport`,
      roles: ["PT_CEMP"],
    },
    {
      label: t("ACTION_TEST_DEFAULTER_REPORT"),
      link: `/mgramseva-digit-ui/employee/reports/search/pt-reports/DefaulterReport`,
    ...
    {
      label: t("ACTION_TEST_DEFAULTER_REPORT"),
      link: `/mgramseva-digit-ui/employee/reports/search/rainmaker-wns/WnsDefaulterReport`,
      roles: ["WS_CEMP"],
    },
    {
      label: t("ACTION_TEST_COLLECTION_REGISTER"),
      link: `/mgramseva-digit-ui/employee/reports/search/rainmaker-wns/WnsCollectionRegisterReport`,
      roles: ["WS_CEMP", "WS_APPROVER", "SW_CEMP", "SW_APPROVER"],
    },
  ];
