...
const ApplicationDetails = (props) => {
  ...
  useEffect(() => {
    switch (selectedAction) {
      ...
      case "FSM_SUBMIT":
        // case !DSO && "SCHEDULE":
        return history.push("/mgramseva-digit-ui/employee/fsm/modify-application/" + applicationNumber);
      case "PAY":
      case "FSM_PAY":
      case "ADDITIONAL_PAY_REQUEST":
        return history.push(`/mgramseva-digit-ui/employee/payment/collect/FSM.TRIP_CHARGES/${applicationNumber}?workflow=FSM`);
      default:
        break;
    }
  }, [selectedAction]);
    ...
    if (checkpoint.status === "CREATED") {
      ...
      return (
        <div>
          ...
          <Link to={`/mgramseva-digit-ui/employee/fsm/rate-view/${applicationNumber}`}>
