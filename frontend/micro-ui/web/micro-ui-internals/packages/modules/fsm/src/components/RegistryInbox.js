...
const RegisryInbox = (props) => {
  ...
  const onActionSelect = (action, type, data) => {
    if (type === "VEHICLE") {
      history.push("/mgramseva-digit-ui/employee/fsm/registry/vehicle-details/" + action);
    } else {
      let driver = data.find((ele) => ele.name === action);
      history.push("/mgramseva-digit-ui/employee/fsm/registry/driver-details/" + driver?.id);
    }
  };
  ...
  const onSelectAdd = () => {
    switch (props.selectedTab) {
      case "VENDOR":
        return history.push("/mgramseva-digit-ui/employee/fsm/registry/new-vendor");
      case "VEHICLE":
        return history.push("/mgramseva-digit-ui/employee/fsm/registry/new-vehicle");
      case "DRIVER":
        return history.push("/mgramseva-digit-ui/employee/fsm/registry/new-driver");
      default:
        break;
    }
  };
        ...
        return [
          {
            ...
            Cell: ({ row }) => {
              return (
                <div>
                  <span className="link">
                    <Link to={"/mgramseva-digit-ui/employee/fsm/registry/vendor-details/" + row.original["id"]}>
                      <div>
                        {row.original.name}
                        <br />
                      </div>
        ...
        return [
          {
            ...
            Cell: ({ row }) => {
              return (
                <div>
                  <span className="link">
                    <Link to={"/mgramseva-digit-ui/employee/fsm/registry/vehicle-details/" + row.original["registrationNumber"]}>
                      <div>
        ...
        return [
          {
            ...
            Cell: ({ row }) => {
              return (
                <div>
                  <span className="link">
                    <Link to={"/mgramseva-digit-ui/employee/fsm/registry/driver-details/" + row.original["id"]}>
                      <div>
                        {row.original.name}
                        <br />
                      </div>
