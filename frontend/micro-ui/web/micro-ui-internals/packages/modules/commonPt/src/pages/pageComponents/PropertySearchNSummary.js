...
const PropertySearchNSummary = ({ config, onSelect, userType, formData, setError, formState, clearErrors }) => {
  ...
  const searchProperty = () => {
    ...
    if (window.location.pathname.includes("/tl/new-application")) {
      history.push(`/mgramseva-digit-ui/employee/tl/new-application?propertyId=${propertyId}`);
      ...
      history.push(`/mgramseva-digit-ui/employee/ws/new-application?propertyId=${propertyId}`);
  };
    ...
    <React.Fragment>
      {(window.location.href.includes("/tl/")
        ...
        <div>
          ...
          <span
            onClick={() =>
              history.push(`/mgramseva-digit-ui/employee/commonpt/search?redirectToUrl=${redirectBackUrl}&${serachParams}`, { ...state })
            }
          >
          ...
          <span
            onClick={() =>
              history.push(`/mgramseva-digit-ui/employee/commonpt/new-application?redirectToUrl=${redirectBackUrl}&${serachParams}`, { ...state })
            }
          >
          ...
          {propertyDetails && propertyDetails?.Properties.length ? (
            <React.Fragment>
              ...
              <Link
                to={`/mgramseva-digit-ui/employee/commonpt/view-property?propertyId=${propertyId}&tenantId=${tenantId}&from=${
