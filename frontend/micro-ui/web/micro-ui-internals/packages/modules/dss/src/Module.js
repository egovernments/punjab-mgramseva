...
const DssBreadCrumb = ({ location }) => {
  ...
  const crumbs = [
    ...
    },
    {
      path:
        checkCurrentScreen() || window.location.href.includes("NURT_DASHBOARD")
          ? "/mgramseva-digit-ui/employee/dss/landing/NURT_DASHBOARD"
          : "/mgramseva-digit-ui/employee/dss/landing/home",
      content: t("ES_LANDING_PAGE"),
      show: true,
    },
    {
      path: fromModule
        ? `/mgramseva-digit-ui/employee/dss/dashboard/${fromModule}`
        : `/mgramseva-digit-ui/employee/dss/dashboard/${Digit.Utils.dss.getCurrentModuleName()}`,
    ...
    {
      path: "/mgramseva-digit-ui/employee/dss/national-faqs",
      content: t("ES_COMMON_DSS_FAQS"),
      show: location.pathname.includes("national-faqs") ? true : false,
    },
    {
      path: "/mgramseva-digit-ui/employee/dss/national-about",
