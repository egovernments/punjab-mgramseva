                    ...
                    onSuccess: async (sewerageData, variables) => {
                      ...
                      await sewerageUpdateMutation(sewerageConnectionUpdate, {
                        ...
                        onSuccess: async (sewerageUpdateData, variables) => {
                          ...
                          history.push(
                            `/mgramseva-digit-ui/employee/ws/ws-response?applicationNumber=${waterUpdateData?.WaterConnection?.[0]?.applicationNo}&applicationNumber1=${sewerageUpdateData?.SewerageConnections?.[0]?.applicationNo}`
                          );
                          // window.location.href = `${window.location.origin}/mgramseva-digit-ui/employee/ws/ws-response?applicationNumber=${waterUpdateData?.WaterConnection?.[0]?.applicationNo}&applicationNumber1=${sewerageUpdateData?.SewerageConnections?.[0]?.applicationNo}`
                        },
                      });
                    },
                  });
            ...
            onSuccess: async (data, variables) => {
              ...
              waterUpdateMutation(waterConnectionUpdate, {
                ...
                onSuccess: (data, variables) => {
                  ...
                  clearSessionFormData();
                  history.push(`/mgramseva-digit-ui/employee/ws/ws-response?applicationNumber=${data?.WaterConnection?.[0]?.applicationNo}`);
                  // window.location.href = `${window.location.origin}/mgramseva-digit-ui/employee/ws/ws-response?applicationNumber=${data?.WaterConnection?.[0]?.applicationNo}`;
                },
              });
            },
          });
            ...
            onSuccess: async (data, variables) => {
              ...
              await sewerageUpdateMutation(sewerageConnectionUpdate, {
                ...
                onSuccess: (data, variables) => {
                  ...
                  clearSessionFormData();
                  history.push(`/mgramseva-digit-ui/employee/ws/ws-response?applicationNumber1=${data?.SewerageConnections?.[0]?.applicationNo}`);
                  // window.location.href = `${window.location.origin}/mgramseva-digit-ui/employee/ws/ws-response?applicationNumber1=${data?.SewerageConnections?.[0]?.applicationNo}`;
                },
              });
            },
          });
