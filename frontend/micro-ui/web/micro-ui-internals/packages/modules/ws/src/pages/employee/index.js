...
const BILLSBreadCrumbs = ({ location }) => {
  ...
  let crumbs = [
    ...
    {
      path: "/mgramseva-digit-ui/employee/ws/water/search-application",
    ...
    {
      path: "/mgramseva-digit-ui/employee/ws/water/search-connection",
    ...
    {
      path: "/mgramseva-digit-ui/employee/ws/consumption-details",
    ...
    // {
    //   path: sessionStorage.getItem("redirectedfromEDIT") === "true"? (applicationNumbercheck?.includes("SW_AP")?  "/mgramseva-digit-ui/employee/ws/sewerage/search-application" : "/mgramseva-digit-ui/employee/ws/water/search-application") : "/mgramseva-digit-ui/employee/ws/application-details",
      ...
      path:
        sessionStorage.getItem("redirectedfromEDIT") === "true"
          ? applicationNumbercheck?.includes("SW_AP")
            ? "/mgramseva-digit-ui/employee/ws/sewerage/search-application"
            : "/mgramseva-digit-ui/employee/ws/water/search-application"
          : "/mgramseva-digit-ui/employee/ws/application-details",
      content: fromScreen ? `${t(fromScreen)} / ${t("WS_APPLICATION_DETAILS_HEADER")}` : t("WS_APPLICATION_DETAILS_HEADER"),
      ...
      path:
        sessionStorage.getItem("redirectedfromEDIT") === "true"
          ? applicationNumbercheck?.includes("SW_AP")
            ? "/mgramseva-digit-ui/employee/ws/sewerage/search-application"
            : "/mgramseva-digit-ui/employee/ws/water/search-application"
          : "/mgramseva-digit-ui/employee/ws/modify-details",
      content: fromScreen ? `${t(fromScreen)} / ${t("WS_APPLICATION_DETAILS_HEADER")}` : t("WS_APPLICATION_DETAILS_HEADER"),
      show: location.pathname.includes("/modify-details") ? true : false,
      isBack: sessionStorage.getItem("redirectedfromEDIT") !== "true" && fromScreen && true,
    },
    {
      path: "/mgramseva-digit-ui/employee/ws/disconnection-details",
      content: fromScreen ? `${t(fromScreen)} / ${t("WS_APPLICATION_DETAILS_HEADER")}` : t("WS_APPLICATION_DETAILS_HEADER"),
      show: location.pathname.includes("/disconnection-details") ? true : false,
      isBack: fromScreen && true,
    },
    {
      path: "/mgramseva-digit-ui/employee/ws/connection-details",
    ...
    {
      path: "/mgramseva-digit-ui/employee/ws/edit-application",
    ...
    {
      path: `/mgramseva-digit-ui/employee/ws/new-disconnection/docsrequired`,
      content: t("WS_NEW_DISCONNECTION_DOCS_REQUIRED"),
      show: location.pathname.includes("/new-disconnection/docsrequired") ? true : false,
    },
    {
      path: `/mgramseva-digit-ui/employee/ws/new-disconnection/application-form`,
      content: isMobile
    ...
    // {
    //   path: "/mgramseva-digit-ui/employee/sewerage/bill-amendment/inbox",
    //   content: t("ES_COMMON_BILLS_SEWERAGE_INBOX_LABEL"),
    //   show: location.pathname.includes("/sewerage/bill-amendment/inbox") ? true : false,
    // },
    {
    ...
    {
      path: "/mgramseva-digit-ui/employee/ws/required-documents",
      content: t("ES_COMMON_WS_DOCUMENTS_REQUIRED"),
      show: location.pathname.includes("/required-documents") ? true : false,
    },
    {
      path: requestParam ? `/mgramseva-digit-ui/employee/ws/bill-amendment?${requestParam}` : "/mgramseva-digit-ui/employee/ws/bill-amendment",
      content: t("WS_BILL_AMEND_APP"),
      show: location.pathname.includes("ws/bill-amendment") && !IsEdit ? true : false,
    },
    {
      path: "/mgramseva-digit-ui/employee/ws/bill-amendment",
      content: t("WS_BILL_AMEND_EDIT_APP"),
      show: location.pathname.includes("ws/bill-amendment") && IsEdit ? true : false,
    },
    {
      path: "/mgramseva-digit-ui/employee/ws/response",
      content: t("WS_ACK_SCREEN"),
      show: location.pathname.includes("/employee/ws/response") ? true : false,
      isclickable: false,
    },
    {
      path: "/mgramseva-digit-ui/employee/ws/generate-note-bill-amendment",
