            ...
            onSuccess: async (data, variables) => {
              ...
              await waterUpdateMutation(waterConnectionUpdate, {
                ...
                onSuccess: (data, variables) => {
                  ...
                  history.push(
                    `/mgramseva-digit-ui/employee/ws/ws-disconnection-response?applicationNumber=${data?.WaterConnection?.[0]?.applicationNo}`
                  );
                },
              });
            },
            ...
            onSuccess: async (data, variables) => {
              ...
              await sewerageUpdateMutation(sewerageConnectionUpdate, {
                ...
                onSuccess: (data, variables) => {
                  ...
                  history.push(
                    `/mgramseva-digit-ui/employee/ws/ws-disconnection-response?applicationNumber=${data?.SewerageConnections?.[0]?.applicationNo}`
                  );
                },
              });
            },
