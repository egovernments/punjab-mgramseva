...
const Acknowledgement = (props) => {
  ...
  //   if(option === "Go Back to home") history.push("/mgramseva-digit-ui/employee")
  //   else if(option === "Create another survey") history.push("/mgramseva-digit-ui/employee/engagement/surveys/create")
  // }

  const actionClickHandler = (option) => {
    if (option === t("GO_BACK_TO_HOME")) history.push("/mgramseva-digit-ui/employee");
    else if (option === t("CREATE_ANOTHER_SURVEY")) history.push("/mgramseva-digit-ui/employee/engagement/surveys/create");
  };
  return (
    <Card>
