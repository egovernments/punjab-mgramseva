...
const EditMessage = () => {
  ...
  const onSubmit = (formData) => {
    ...
    history.push("/mgramseva-digit-ui/employee/engagement/messages/response?update=true", details);
  };
  ...
  return (
    <Fragment>
      ...
      <FormComposer defaultValues={defaultValues} config={config} onSubmit={onSubmit} label={t("ACTION_EDIT_MESSAGE")}></FormComposer>
    </Fragment>
  );
};
