    ...
    <div>
      ...
      <div className="notice_and_circular_main gap-ten">
        <div className="documentDetails_wrapper">
          ...
          <div className="documentDetails_row_items">
            <p className="documentDetails_title">{`${t("PUBLIC_BRDCST_TITLE_LABEL")}:`}</p> <p>{data?.applicationData?.name}</p>{" "}
          </div>
          <div className="documentDetails_row_items">
            <p className="documentDetails_title">{`${t("EVENTS_COMMENTS_LABEL")}:`}</p>{" "}
