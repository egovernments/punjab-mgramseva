...
const PGRCard = () => {
  ...
  const allLinks = [
    { text: t("ES_PGR_INBOX"), link: "/mgramseva-digit-ui/employee/pgr/inbox" },
    { text: t("ES_PGR_NEW_COMPLAINT"), link: "/mgramseva-digit-ui/employee/pgr/complaint/create", accessTo: ["CSR"] },
  ];
  ...
  let propsForCSR = [
    {
      ...
      link: `/mgramseva-digit-ui/employee/pgr/complaint/create`,
      role: "CSR",
    },
  ];
  ...
  const propsForModuleCard = {
    ...
    kpis: [
      {
        label: t("TOTAL_PGR"),
        link: `/mgramseva-digit-ui/employee/pgr/inbox`,
      },
      {
