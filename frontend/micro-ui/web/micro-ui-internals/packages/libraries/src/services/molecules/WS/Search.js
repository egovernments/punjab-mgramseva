    ...
    const propertyDetails = {
      ...
      additionalDetails: {
        redirectUrl: {
          ...
          url: `/mgramseva-digit-ui/employee/pt/property-details/${propertyDataDetails?.propertyId}?from=WS_APPLICATION_DETAILS_HEADER`,
        },
      },
    };
    ...
    const propertyDetails = {
      ...
      values: [
        ...
        },
        {
          ...
          oldValue:
            getOwnerNames(propertyDataDetails) != getOwnerNames(oldPropertyDetails)
              ? [
        ...
        serviceType == "WATER"
          ? [
              ...
              { title: "WS_INITIAL_METER_READING_LABEL", value: wsDataDetails?.additionalDetails?.initialMeterReading || t("NA") },
              {
                ...
                to: `/mgramseva-digit-ui/employee/ws/consumption-details?applicationNo=${wsDataDetails?.connectionNo}&tenantId=${
    ...
    const propertyDetails = {
      ...
      values: [
        ...
        },
        {
          ...
          to: `/mgramseva-digit-ui/employee/pt/property-details/${propertyDataDetails?.propertyId}?from=${
            window.location.href.includes("bill-details") ? "ABG_BILL_DETAILS_HEADER" : "WS_COMMON_CONNECTION_DETAIL"
          }`,
          value: "",
          isLink: true,
