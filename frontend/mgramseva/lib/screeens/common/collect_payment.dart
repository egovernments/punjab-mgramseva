...
class _ConnectionPaymentViewState extends State<ConnectionPaymentView> {
  ...
  Future <http.Response> payGovTest() async {
    ...
    map['checksum'] = '${postUri.queryParameters['checksum']}';
    map['messageType'] = '${postUri.queryParameters['messageType']}';
    map['merchantId'] = '${postUri.queryParameters['merchantId']}';
    map['serviceId'] = '${postUri.queryParameters['serviceId']}';
    map['orderId'] = '${postUri.queryParameters['orderId']}';
    map['customerId'] = '${postUri.queryParameters['customerId']}';
    map['transactionAmount'] = '${postUri.queryParameters['transactionAmount']}';
    map['currencyCode'] = '${postUri.queryParameters['currencyCode']}';
    map['requestDateTime'] = '${dateStringPrefix[0]}${now.year} ${dateStringPrefix[1]}';
    map['successUrl'] = '${postUri.queryParameters['successUrl']}';
    map['failUrl'] = '${postUri.queryParameters['failUrl']}';
    map['additionalField1'] = '${postUri.queryParameters['additionalField1']}';
    map['additionalField2'] = '${postUri.queryParameters['additionalField2']}';
    map['additionalField3'] = '${postUri.queryParameters['additionalField3']}';
    map['additionalField4'] = '${postUri.queryParameters['additionalField4']}';
    map['additionalField5'] = '${postUri.queryParameters['additionalField5']}';
    return http.post(postUri,
      headers: {
