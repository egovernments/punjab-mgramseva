  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
          child: FormWrapper(Consumer<SearchConnectionProvider>(
            ...
            children: [
              ...
              Card(
                  child: Form(
                      ...
                      autovalidateMode: searchConnectionProvider.autoValidation
                      ...
                      child: Column(
                          ...
                          children: [
                            LabelText(i18
                                .searchWaterConnection.SEARCH_CONNECTION_LABEL),
                            ...
                            BuildTextField(
                              ...
                              pattern: (searchConnectionProvider
                                              ...
                                              .controllers[0] ==
                                          null ||
                                      searchConnectionProvider.searchconnection
                                              .controllers[0] ==
                                          false)
                                  ? (r'^(?:[+0]9)?[0-9]{10}$')
                                  : '',
                              message: i18
                                  .validators.MOBILE_NUMBER_SHOULD_BE_10_DIGIT,
                              inputFormatter: [
                              ...
                              onChange: (value) =>
                                  searchConnectionProvider.getdetails(value, 0),
                            ),
                            Text(
                              '\n-(or)-',
                                    ...
                                    children: [
                                      ...
                                      BuildTextField(
                                        i18.searchWaterConnection
                                            .OLD_CONNECTION_ID,
                                        searchConnectionProvider
                                            .searchconnection.oldConnectionCtrl,
                                        isDisabled: searchConnectionProvider
                                      ...
                                      BuildTextField(
                                        i18.searchWaterConnection
                                            .NEW_CONNECTION_ID,
                                        searchConnectionProvider
                                            .searchconnection.newConnectionCtrl,
                                        isDisabled: searchConnectionProvider
