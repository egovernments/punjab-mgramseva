...
class _RevenueChartsState extends State<RevenueCharts> {
  ...
  Widget _buildDesktopView() {
    ...
    return Row(
      ...
      children: [
        Expanded(
            child: _buildChartWithCardView(_buildStackedCharts(),
                _buildButton(revenueProvider.getTabs(context).first))),
        SizedBox(width: 8),
        Expanded(
            child: _buildChartWithCardView(_buildLineCharts(true),
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text(
                '${ApplicationLocalizations.of(context).translate(i18.dashboard.REVENUE_EXPENDITURE_TREND)}',
      ...
      builder: (_, revenueProvider, child) {
        ...
        return Wrap(
            ...
            children: List.generate(
                tabs.length,
                (index) => _buildButton(
                    tabs[index], index, revenueProvider.setSelectedTab)));
      },
    );
  }
  ...
  Widget _buildStackedCharts() {
    ...
    return Column(children: [
      Container(height: 250, child: StackedBarChart.withSampleData()),
      Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
                child: _buildStackedLegends(i18.dashboard.EXPENDITURE, expense))
          ],
        ),
      )
    ]);
        ...
        children: [
          ...
          Expanded(
            child: Wrap(
                ...
                runSpacing: 10,
                children: legends
                    .map((e) => _buildLegend(e.label, e.color))
                    .toList()),
          )
        ]);
  }
    ...
    return Column(children: [
      ...
      Container(
        ...
        child: Wrap(
          ...
          children: [
            _buildLegend(
                i18.dashboard.REVENUE, Color.fromRGBO(64, 106, 187, 1)),
            _buildLegend(
                i18.dashboard.EXPENDITURE, Color.fromRGBO(11, 12, 12, 1)),
          ],
        ),
      )
    ]);
  ...
  Widget _buildLegend(String label, Color color) {
    return Wrap(
      ...
      children: [
        ...
        Text(
          '${ApplicationLocalizations.of(context).translate(label)}',
          style: TextStyle(fontSize: 12, color: Color.fromRGBO(11, 12, 12, 1)),
        )
      ],
    );
  }
  ...
  Widget _buildButton(String label, [int? index, Function(int)? callBack]) {
    ...
    return OutlinedButton(
      onPressed: () =>
          callBack != null && index != null ? callBack(index) : () {},
      style: OutlinedButton.styleFrom(
          side: BorderSide(
              width: 1.0,
              color: (revenueProvider.selectedIndex == index) || index == null
