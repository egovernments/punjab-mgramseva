...
class _EditProfileState extends State<EditProfile> {
  ...
  saveInputandedit(context, profileDetails, User profile) async {
    ...
    if(userProvider.formKey.currentState!.validate()) {
      var editProfileProvider = Provider.of<UserEditProfileProvider>(
        ...
        children: [
          ...
          Consumer<UserProfileProvider>(
            builder: (_, userProvider, child) => Form(
              autovalidateMode: userProvider.autoValidation ? AutovalidateMode.always : AutovalidateMode.disabled,
