  ...
  static List<HomeItem> HOME_ITEMS = [
    HomeItem(
      ...
      ApplicationLocalizations.of(navigatorKey.currentContext!)
          .translate(i18.homeWalkThroughMSg.HOUSEHOLD_REGISTER_MSG),
    ...
    HomeItem(
        ...
        ApplicationLocalizations.of(navigatorKey.currentContext!)
            .translate(i18.homeWalkThroughMSg.COLLECT_PAYMENTS_MSG),
    ...
    HomeItem(
        "ADD_EXPENSES_RECORD",
        ApplicationLocalizations.of(navigatorKey.currentContext!)
            .translate(i18.homeWalkThroughMSg.ADD_EXPENSE_RECORD_MSG),
    ...
    HomeItem(
        ...
        ApplicationLocalizations.of(navigatorKey.currentContext!)
            .translate(i18.homeWalkThroughMSg.UPDATE_EXPENSE_MSG),
    ...
    HomeItem(
        ...
        ApplicationLocalizations.of(navigatorKey.currentContext!)
            .translate(i18.homeWalkThroughMSg.GENERATE_DEMAND_MSG),
    ...
    HomeItem(
        ...
        ApplicationLocalizations.of(navigatorKey.currentContext!)
            .translate(i18.homeWalkThroughMSg.CREATE_CONSUMER_MSG),
    ...
    HomeItem(
        ...
        ApplicationLocalizations.of(navigatorKey.currentContext!)
            .translate(i18.homeWalkThroughMSg.UPDATE_CONSUMER_DETAILS_MSG),
    ...
    HomeItem(
        ...
        ApplicationLocalizations.of(navigatorKey.currentContext!)
            .translate(i18.homeWalkThroughMSg.GPWSC_DASHBOARD_MSG),
        HomeIcons.dashboard,
        'dashboard',
        {}),
  ];
