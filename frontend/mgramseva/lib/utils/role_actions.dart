  ...
  List<String> getRolesBasedOnModule(String route) {
    switch (route) {
      ...
      case Routes.HOUSEHOLD:
        return ['COLLECTION_OPERATOR', 'SUPERUSER', 'DIV_ADMIN','SARPANCH','SECRETORY'];

      case Routes.CONSUMER_UPDATE:
        return ['GP_ADMIN', 'SUPERUSER', 'COLLECTION_OPERATOR', 'DIV_ADMIN','SARPANCH','SECRETORY'];
      ...
      case Routes.HOUSEHOLD_DETAILS:
        return ['BULK_DEMAND_PROCESSING', 'COLLECTION_OPERATOR', 'SUPERUSER', 'DIV_ADMIN','SARPANCH','SECRETORY'];
